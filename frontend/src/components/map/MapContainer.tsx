...
import { useGlobeStore, altitudeToLeafletZoom, leafletZoomToAltitude, MAP_RETURN_ALTITUDE } from '../../store/globeStore'
...
export function MapView({ markers, onEventClick, onPersonClick, onLocationClick, isShifted }: MapViewProps) {
  const { cameraPosition, setCameraPosition, setViewMode, setViewportBounds } = useGlobeStore()
  ...
  const handleZoomChange = useCallback((newZoom: number) => {
    ...
    // Check if we should return to globe
    if (newAltitude > MAP_RETURN_ALTITUDE) {
  ...
  }, [setCameraPosition, setViewMode, setViewportBounds, cameraPosition.lat, cameraPosition.lng])
